...
<div class='container'>
	...
	<fieldset><legend><b>Order Details</b></legend>
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method='get'>
			...
			<label for='phone'>Phone: </label><input type=text name='phone' class='formInputItem' pattern="[0-9]*" minlength="10" maxlength="10" required><br>
			<label for='payment'>Payment: </label><input type=radio name='payment' value='COD' required> Cash On Delivery<br>
