	...
	<div class="mybox" style="display:inline-block;">
		...
		<div id="createAccountPrompt" style="display:none;">
			<form id='createAccountForm' method='post' action='createAccount.php'>
				...
				<input id='newUserUserName' class="inputItem" type=text name='newUserName'placeholder="Pick a Username" pattern="[a-zA-Z]*" required><br>
				<input id='newUserName' class="inputItem" type=text name='newName' placeholder="Name" pattern="[a-zA-Z]*" required><br>
